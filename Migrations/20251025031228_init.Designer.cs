...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EngineeringCoperation.Models.Access", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EngineeringCoperation.Models.Balance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EngineeringCoperation.Models.Exchange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EngineeringCoperation.Models.Inhouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EngineeringCoperation.Models.Installment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EngineeringCoperation.Models.Loan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EngineeringCoperation.Models.Member", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EngineeringCoperation.Models.Saving", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EngineeringCoperation.Models.Access", b =>
                {
                    b.HasOne("EngineeringCoperation.Models.Member", "Member")
                        .WithMany("Accesses")
            ...
            modelBuilder.Entity("EngineeringCoperation.Models.Inhouse", b =>
                {
                    b.HasOne("EngineeringCoperation.Models.Member", "Destination")
                        .WithMany("DestinationTransactions")
                        .HasForeignKey("DestinationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EngineeringCoperation.Models.Member", "Origin")
            ...
            modelBuilder.Entity("EngineeringCoperation.Models.Installment", b =>
                {
                    b.HasOne("EngineeringCoperation.Models.Loan", "Loan")
